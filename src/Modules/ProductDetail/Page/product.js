...
const product = () => {
    ...
    <>
        <div class="single-product">
            <div class="col-2">
                ...
                <div class="certification">
                    <p><i class='bx bxs-heart'></i>100% health guarantee for pets</p>
                    <p><i class='bx bxs-dog'></i>100% guarantee of pet identification</p>
                </div>
                <div class="contact-box">
                    <div class="share-box" style="display: inline-flex;">
                        <p style="display: inline-flex;"><i class='bx bx-share-alt' style="display: inline-flex;"></i>Share:</p>
                    </div>
        ...
        <div class="Gallery">
            <div class="slider">
                ...
                <div class="image-list">
                    <a><img src="TEST/images/product-1.jpg" alt="" class="active"></img></a>
        ...
        <a href="#" class="scroll-top"><i class='bx bxl-messenger'></i></a>
